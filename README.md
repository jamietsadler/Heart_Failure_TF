Uses a dataset from Kaggle to predict heart failure survival from serum creatinine and ejection fraction, and other factors such as age, anemia, diabetes, and so on.
